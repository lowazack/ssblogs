...
<html <?php language_attributes(); ?> class="no-js">
	...
	<body <?php body_class(); ?>>
      ...
      <div class="header">
        <div class="row">
          <div class="columns">
            <a class="header__logo" href="https://news.privacyweb.com/">
              <img src="https://static.privacyweb.com/img//layout/_privacyweb/news/logo.png?build-8.88">
            </a>
            <span class="header__slogan">
      Security News
    </span>
            <div class="header__links-container">
              <a class="header__button" href="https://secure.privacyweb.com/">Get PrivacyWeb</a>
            ...
            <div news-mobile-menu-dropdown="" class="header__mobile-nav">
              <a class="header__mobile-nav-link" href="https://secure.privacyweb.com/">Get PrivacyWeb</a>
              <a class="header__mobile-nav-link" href="https://www.privacyweb.com/#login">Login</a>
            </div>
          </div>
        </div>
      </div>
